...
Degen Town is A virtual town where AI DEGENs live, chat and pump.

This project is a deployable starter kit for easily building and customizing your own version of Degen Town.
...
`bash
    ./convex-local-backend
    `
And in the second terminal simply Configuring Socat, Launch Degen Town.
...
### 9. Clone the Degen Town Repository

Clone the Degen Town repository from GitHub:
...
### 14. Launch Degen Town

Finally, launch Degen Town:

    npm run dev

Visit `http://localhost:5173` in your browser to see Degen Town in action.

### Relaunching Degen Town on windows WSL :
...
In another terminal : 3. Launch Degen Town:
