    ...
    <main className="relative flex min-h-screen flex-col items-center justify-between font-body game-background">
      ...
      >
        <div className="font-body">
          ...
          <p>
            Welcome to Degen Town. Degen Town supports both anonymous <i>spectators</i> and logged
          ...
          <p className="mt-4">
            Degen Town only supports {MAX_HUMAN_PLAYERS} humans at a time. If you're idle for five
